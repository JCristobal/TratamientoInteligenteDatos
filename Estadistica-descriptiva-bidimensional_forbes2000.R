...
#scatter plot, con colores  y formas segun su categoria ("retalling" en cabeza, seguido de "Oil & gas operations" y "Consumer durables")
plot(Forbes2000$sales,Forbes2000$rank, col=Forbes2000$category, pch=as.numeric(Forbes2000$category))
legend('topright', legend=categorias, col = categorias, pch=as.numeric(categorias), bty='n', cex=.50)
#scatter plot, con colores  y formas para ver las GANANCIAS según la categoria (predomina la "Banca")
